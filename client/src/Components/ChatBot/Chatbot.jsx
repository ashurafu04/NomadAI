...
import EnhancedFormatter from "../EnhancedFormatter/EnhancedFormatter";
import "./ChatBot.css";
    ...
    <div className="app-container">
      <div className="chat-container">
        <div className="chat-header">
          <div className="logo">
            <h1>Wohoo, let's talk !</h1>
          </div>
          <p className="subtitle">I’m Nomadai, your personal travel planner</p>
        </div>
